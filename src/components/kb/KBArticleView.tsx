...
import { KBArticle, kbCategories, kbComments } from "@/data/kbMockData";
...
export function KBArticleView({ article, onBack, onEdit, onSearchClick }: KBArticleViewProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <KBHeader onSearchClick={onSearchClick} onMenuClick={() => {}} />
      ...
      <div className="sticky top-16 z-40 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="max-w-4xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" className="gap-2 rounded-lg" onClick={onEdit}>
        ...
        <section className="mt-10">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-end mt-2">
                  <Button size="sm" className="rounded-lg">Post Comment</Button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {articleComments.map((comment) => (
              <div key={comment.id} className="p-4 rounded-xl border border-border bg-card/50">
...
function formatContent(content: string): string {
  // Basic markdown-style formatting for demo
  return content
    ...
    .replace(/@(\w+)/g, '<span class="px-1.5 py-0.5 bg-primary/10 text-primary rounded-full text-sm font-medium">@$1</span>')
    .replace(/\n\n/g, '</p><p class="my-4">')
